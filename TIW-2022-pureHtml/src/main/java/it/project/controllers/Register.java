...
/**
 * Checks the request parameters, if they're correct inserts the new client in the DB then return to Login HTML page
 */
@WebServlet("/Register")
public class Register extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(username.isEmpty() || password.isEmpty() || passwordConfirm.isEmpty() || username == null || password == null || passwordConfirm == null)
