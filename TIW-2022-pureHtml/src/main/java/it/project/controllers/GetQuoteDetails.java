...
/**
 * If the session is from a client user, gets the quote from 'userQuotes' with the same is as the parameter and sets it as the 'chosenQuote'.
 * If the session is from an employee user, gets the quote from 'newQuotes' and does the same, then redirects to the HTML Page where could be set the price.
 */
...
public class GetQuoteDetails extends HttpServlet {
    ...
    /**
     * Sets the 'chosenQuote' from a quote List already saved in the session, then process to another page
