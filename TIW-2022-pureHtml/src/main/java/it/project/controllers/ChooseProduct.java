...
/**
 * Gets a product from the 'productsList' stored in the session and encapsulates is in a new Product object,
 * then stores it in the session.
 */
...
public class ChooseProduct extends HttpServlet {
    ...
    /**
     * Calls the DAO and gets the product identified by request parameter 'productId'
